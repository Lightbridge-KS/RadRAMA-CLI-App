---
title: "My Open Weather"
format: html
---

```{r setup, include=FALSE}
knitr::opts_knit$set(root.dir = rprojroot::find_rstudio_root_file())
here::i_am("explore/my-openweather.qmd")
library(here)
library(jsonlite)
library(cli)
```
...
url_bkk <- weather_create_url(city = "bangkok", units = "c")
url_bkk
```

### Get Current Weather (list)

```{r weather_current_ls}
...
weather_current_ls("bangkok")
```


### Current Weather Report

```{r weather_current_report}
...
weather_current_report("bangkok", units = "k")
```

```{r}
weather_current_report("london")
```
